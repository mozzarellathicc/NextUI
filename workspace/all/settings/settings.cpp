...
int main(int argc, char *argv[])
{
    try
    {
        ...
        auto systemMenu = new MenuList(MenuItemType::Fixed, "System",
        {
            ...
            new MenuItem{ListItemType::Generic, "Save format", "The save format to use.", {(int)SAVE_FORMAT_SAV, (int)SAVE_FORMAT_SRM, (int)SAVE_FORMAT_GEN}, {"MinUI (default)", "Retroarch", "Generic"}, []() -> std::any
